...
-- MySQL dump 10.13  Distrib 8.0.40, for Linux (x86_64)
--
-- Host: localhost    Database: HotelManagementSysteme
-- ------------------------------------------------------
-- Server version	8.0.40-0ubuntu0.24.04.1
...
CREATE TABLE `book` (
  ...
  CONSTRAINT `book_ibfk_2` FOREIGN KEY (`roomID`) REFERENCES `rooms` (`roomID`)
...
INSERT INTO `book` VALUES (1,'Ezra',1,'2024-12-18','2024-12-21','unpaid');
...
-- Dump completed on 2024-12-18 23:01:46
