...
LOCK TABLES `book` WRITE;
/*!40000 ALTER TABLE `book` DISABLE KEYS */;
INSERT INTO `book` VALUES (1,'Ezra',1,'2024-12-18','2024-12-21','unpaid',300.00),(2,'Ezra',2,'2024-12-20','2024-12-25','unpaid',500.00);
/*!40000 ALTER TABLE `book` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-12-19 22:40:08
